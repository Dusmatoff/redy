...
jQuery(function ($) {
	...
	$('.select2-selection__rendered').each(function () {
		var $this = $(this).parent().parent().parent().prev().data('placeholder');
		$(this).html($this);
	});
});